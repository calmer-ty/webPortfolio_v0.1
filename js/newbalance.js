...
function lnbView() {
  for (let i = 0; i < gnbTarget.length; i++) {
    gnbTarget[i].addEventListener("mouseover", function () {
      if (i == 0) {
        lnbWrap[0].classList.add("active");
      }
      if (i == 1) {
        lnbWrap[1].classList.add("active");
      }
      if (i == 2) {
        lnbWrap[2].classList.add("active");
      }
      if (i == 3) {
        lnbWrap[3].classList.add("active");
      }
    });
    gnbTarget[i].addEventListener("mouseout", function () {
      if (i == 0) {
        lnbWrap[0].classList.remove("active");
      }
      if (i == 1) {
        lnbWrap[1].classList.remove("active");
      }
      if (i == 2) {
        lnbWrap[2].classList.remove("active");
      }
      if (i == 3) {
        lnbWrap[3].classList.remove("active");
      }
    });
  }
}
...
function scrollEvent() {
  ...
  window.onscroll = function () {
    ...
    for (let i = 0; i < seriesItem.length; i++) {
      if (window.scrollY > 1900) seriesItem[i].classList.add("active");
      else seriesItem[i].classList.remove("active");
    }
    ...
    for (let i = 0; i < liveFitItem.length; i++) {
      if (window.scrollY > 3300 && i == 0)
        ...
        liveFitItem[i].classList.add("active");
      else liveFitItem[i].classList.remove("active");
    }
  };
}
